...
- 主管待查核清單：集中顯示待查核、逾期、今日到期、急件未結、超過 7 天未回報與最近完成待確認的案件。
...
- 同仁回報提醒：彙整每位同仁近 7 日更新、需追蹤工項、未完成案件、逾期、待查核與今日/3 日內到期案件，標示「今天要追」「本週追蹤」「有更新」，並可快速篩選提醒等級、一鍵跳到該同仁待查核案件或複製個人提醒文字。
